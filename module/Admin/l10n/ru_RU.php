...
return [
    ...
    'Status & statistics' => 'Статус и статистика',
    ...
    // Tours
    'Parser' => 'Парсер',
    'TOUR_PARSER_INTRO' => '<p>Шаблоны электронной почты могут включать в себя динамические выражения, которые будут заменены на соответствующий им текст</p>',
    'TOUR_PARSER_MAIL' => '<p>Начните работу с CorpNews с отправки шаблона новостного письма как сообщения электронной почты на ящик приложения.</p>',
    ...
    'TOUR_GROUPS_INTRO' => '<p>Почтовая кампания рассылает письма группам клиентов.</p>'
        . '<p>Вы можете определить эти группы здесь.</p>',
    ...
    'TOUR_TAGS_INTRO' => '<p>Почтовой рассылке может быть назначено некоторое число тегов.</p>'
        ...
        . '<p>По умолчанию все клиенты подписаны та теги, которые вы создаете</p>',
    'Campaigns' => 'Кампании',
