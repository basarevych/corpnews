...
return [
    ...
    'CAMPAIGN_NO_TESTERS' => 'Тестировщики не найдены.'
        . '<br><br>'
    ...
    // Demo
    'DEMO_LOGIN' => '<p>Это демо версия CorpNews. Логин: "admin", пароль: "passwd"</p>'
        . '<p>Обратите внимание, эта инсталляция обнуляется каждый день в 13:00 GMT, в это время возможны ошибки</p>',
    'DEMO_FUNCTION_DISABLED' => 'CorpNews работает в режиме демо-версии. Эта функция отключена.',
    'DEMO_MOCK_SENDING' => '<p><em>Так как это демо-версия, то на самом деле почта не отправляется.'
        . ' Вы можетe посмотреть сгенерированные письма в Почта / Исходящие сообщения.</em></p>'
        . '<p><em>Если вы на самом деле хотите получить письмо, нажмите кнопку "Тестировать кампанию".</em></p>',
];
