...
return [
    ...
    'DEMO_MOCK_SENDING' => '<em>Так как это демо-версия, то на самом деле почта не отправляется.'
        . ' Вы можетe посмотреть сгенерированное письмо в Почта / Исходящие сообщения.</em>',
];
