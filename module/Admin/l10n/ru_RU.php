...
return [
    ...
    'Success' => 'Успех',
    'Failure' => 'Неудача',
    'CONFIRM_DELETE_LETTER' => 'Удалить выбранное письмо(-ма)?',
    'CONFIRM_REANALYZE_LETTER' => 'Сбросить статус выбранного письма(-сем)?<br><br>Письмо вскоре снова появится в одной из папок почтового ящика',
